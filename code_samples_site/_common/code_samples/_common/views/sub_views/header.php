                ...
                <div id="at_top" class="span12">
                                ...
                                <div class="nav-collapse collapse navbar-responsive-collapse">
                                    <ul class="nav">
                                        ...
                                        <li class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li>
                                                    <a href="" target="blank">all-in-one</a>
                                                </li>
                                                <li class="divider"></li>
                                                <li class="nav-header">PHP downloads</li>
                                                <li>
                                                    <a href="" target="blank">ajax_print</a>
                                                </li>
                                                <li>
                                                    <a href="" target="blank">tj's resume app</a>
                                                </li>
                                                <li class="divider"></li>
                                                <li class="nav-header">PDF downloads</li>
                                                <li>
                                                    <a href="" target="blank">tj's resume pdf</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li>
                                                    <a href="" target="blank">pdf download</a>
                                                </li>
                                                <li>
                                                    <a href="" target="blank">php download</a>
                                                </li>
                                            </ul>
                                        </li>
                                    </ul>
		            ...
		            <div class="row-fluid" style="margin: -10px auto 2px auto;">
        	            <div class="span12" style="text-align: right; ">
							<a class="btn btn-success btn-small" href="" target="_blank">all-in-one download</a>
					    </div>
				    </div>
                    <!-- END NAVIGATION -->
                    <?php endif; ?>
